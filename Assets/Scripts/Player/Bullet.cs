...
public class Bullet : RecycleObject
{
    ...
    //private void Start()      // Start는 한번만 실행되기 때문에 재사용할 때 문제가 된다.
    //{
...
// Vector는 힘의 크기(Scalar)와 방향(direction)을 나타낸다.
// 벡터 중에서 스칼라가 1인 벡터를 Unit Vector라고 한다. => 정규화된 벡터는 수누하게 방향만 남은 벡터가 된다.