...
public class EnemySpawner : MonoBehaviour
{
    ...
    protected Vector3 GetSpawnPosition()
    {
        ...
        pos.x += Random.Range(MinX, MaxX);  // 현재 위치에서 높이만 (-4 ~ +4) 변경
    ...
    protected virtual void OnDrawGizmos()
    {
        ...
        Vector3 p0 = transform.position + Vector3.left * MaxX;    // 선의 시작점 계산
        Vector3 p1 = transform.position + Vector3.left * MinX;    // 선의 도착점 계산
